...
public class ControllerExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
    public ResponseEntity<List<CustomErrorResponse>> argNotValidError(MethodArgumentNotValidException e) {
    ...
    public ResponseEntity<CustomErrorResponse> handleGenericArithmeticException(ArithmeticException e) {
